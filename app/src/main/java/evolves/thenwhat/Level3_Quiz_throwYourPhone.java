...
public class Level3_Quiz_throwYourPhone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RadioButton y = (RadioButton)findViewById(R.id.yes);
        RadioButton n = (RadioButton)findViewById(R.id.no);
        ...
        y.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                editor.putString("quizLevelThree" , "Yes");
                editor.putBoolean("quizLevelThreeIsOk" , true);
                editor.apply();
                Intent iT = new Intent(getBaseContext() , Level3.class);
                startActivity(iT);
            }
        });
        ...
        n.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                editor.putString("quizLevelThree" , "no");
                editor.putBoolean("quizLevelThreeIsOk" , false);
                editor.apply();
                Intent iT = new Intent(getBaseContext() , Level3.class);
                startActivity(iT);
            }
